!function(){"use strict";
	function t(o){if(!o)throw new Error("No options passed to Waypoint constructor");
...
t.invokeAll=function(t){var e=[];for(var o in i)e.push(i[o]);for(var n=0,r=e.length;r>n;n++)e[n][t]()},
...
function(){
	...
	function t(t){
		...
		function e(t){
			this.element=t,this.Adapter=n.Adapter,
...
e.prototype.createThrottledScrollHandler=function(){function t(){
		e.handleScroll(),
		e.didScroll=!1
	}
...
for(var i in e){var o=e[i],n=o.newScroll>o.oldScroll,r=n?o.forward:o.backward;
	for(var s in this.waypoints[i]){
		...
		l=o.oldScroll<a.triggerPoint,h=o.newScroll>=a.triggerPoint,p=l&&h,u=!l&&!h;(p||u)&&(a.queueTrigger(r),
			...
			e.prototype.refresh=function(){
				...
				o={};this.handleScroll(),
				t={
					horizontal:{contextOffset:e?0:i.left,contextScroll:e?0:this.oldScroll.x,
	...
	for(var r in t){
		...
		var a in this.waypoints[r]){
			...
			d.triggerPoint=y+l-f,h=w<s.oldScroll,
			p=d.triggerPoint>=s.oldScroll,u=h&&p,c=!h&&!p,
	...
	this.clearTriggerQueues()},
	i.prototype.next=function(e){this.waypoints.sort(t);
	...
	var e=window.jQuery,i=window.Waypoint;e.each(
			["innerHeight",
			 "innerWidth",
			 "off",
			 "offset",
	...
	function(i,o){t[o]=e[o]}),i.adapters.push({name:"jquery",Adapter:t}),
		i.Adapter=t}(),
	function(){"use strict";function t(t){
		return function(){
			var i=[],
