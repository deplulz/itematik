			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="owl-carousel owl-carousel-fullwidth">
						...
						<div class="item">
							<img src="<?php echo base_url('assets/images/img_5.jpg');?>" alt="Free HTML5 Bootstrap Template by GetTemplates.co">
						</div>
						<div class="item">
							<img src="<?php echo base_url('assets/images/img_6.jpg');?>" alt="Free HTML5 Bootstrap Template by GetTemplates.co">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-6 animate-box" data-animate-effect="fadeIn">
					<div class="gtco-staff">
						<img src="<?php echo base_url('assets/images/person_1.jpg');?>" alt="Free HTML5 Templates by gettemplates.co">
						<h3>Jean Smith</h3>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 animate-box" data-animate-effect="fadeIn">
					<div class="gtco-staff">
						<img src="<?php echo base_url('assets/images/person_2.jpg');?>" alt="Free HTML5 Templates by gettemplates.co"><h3>Hush Raven</h3>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 animate-box" data-animate-effect="fadeIn">
					<div class="gtco-staff">
						<img src="<?php echo base_url('assets/images/person_2.jpg');?>" alt="Free HTML5 Templates by gettemplates.co">
						<h3>Alex King</h3>
